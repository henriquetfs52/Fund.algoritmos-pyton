#FeiTv_v2.py contém exatamente o mesmo código que o FeiTv.py entretanto todas as vezes que um arquivo .txt é chamado, o endereço NÃO contém a pasta /ProjetoStreaming, pois o terminal de comandos
#do meu computador já estava na pasta ProjetoStreaming, e não encontrava o endereço se era requisitado abrir a pasta novamente
...
def remover_curtida():
    ...
    Novo_Curtidos = open("Curtidos.txt", "w", encoding="utf-8")
